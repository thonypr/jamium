public final class Responses {
    ...
    public static final String TASK_3_1 = "Формат ответа: число (13 символов)";
    ...
    public static final String TASK_4_2 = "Формат ответа: строка в 5 символов (цифры и английские буквы; регистр не имеет значения)";
    public static final String CONGRAT_4_1 = "Верно!\n Верно";
    public static final String CONGRAT_4_2 = "Верно!";
    public static final String CLOSE_4_1 = "На верном пути!";
    public static final String CLOSE_4_2 = "На верном пути!";
