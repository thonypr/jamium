...
//        con.setRequestProperty("Accept-Language", "en-US,en;q=0.5");
    ...
    public static void sendDirectPost(String text, String id, String botToken) throws Exception {
...
//        con.setRequestProperty("Accept-Language", "en-US,en;q=0.5");
        ...
        String urlParameters = "chat_id=:CHAT&text=:TEXT".replace(":CHAT", String.valueOf(id)).replace(":TEXT", text);
